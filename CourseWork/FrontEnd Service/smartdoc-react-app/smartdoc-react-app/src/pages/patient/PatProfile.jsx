import Sidebar from "../../components/PatSidebar";
import '@/styles/PatProfile.css';

export default function DocProfile() {
    return (
        <div className="pat-pro-wrapper">
            <Sidebar />
            <div className="pat-pro-main">
                <div className="pat-pro-header">
                    <h3>My Profile</h3>
                    <p>Manage your personal information and credentials</p>
                </div>

                <div className="pat-pro-card">
                    <div className="pat-pro-card-header">
                        <h2>Profile Information</h2>
                        <button className="pat-pro-edit-btn">Edit Profile</button>
                    </div>

                    <form className="pat-pro-form">
                        <div className="pat-pro-form-group">
                        ...
                        <div className="pat-pro-form-group-full-width">
                ...
                <div className="pat-pro-pass-header">
                    <h2>Change Password</h2>
                </div>

                <div className="pat-pro-pass-card">
                    <form className="pat-pro-pass-form">
                        <div className="pat-pro-pass-form-group">
                        ...
                        <div className="pat-pro-pass-form-group-full-width">
